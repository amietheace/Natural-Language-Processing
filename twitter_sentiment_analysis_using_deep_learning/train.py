...
import CNN             #OPTION 2 (Model by: Danny Britz)
...
filename = "tweets.csv"
goodfile = "goodtweets1.csv"
badfile = "badtweets2.csv"


# Load data
print("Loading data...")
x_text, y = batchgen.get_dataset(goodfile, badfile, 5000) #TODO: MAX LENGTH, dataset[0], dataset[1]
